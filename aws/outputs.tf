...
output "this_ec2_transit_gateway_route_table_default_association_route_table" {
  ...
  value       = [for k, v in aws_ec2_transit_gateway_route_table.this: v.default_association_route_table]
}
...
output "this_ec2_transit_gateway_route_table_default_propagation_route_table" {
  ...
  value       = [for k, v in aws_ec2_transit_gateway_route_table.this: v.default_propagation_route_table]
}
...
output "this_ec2_transit_gateway_route_ids" {
  ...
  value       = [for k, v in aws_ec2_transit_gateway_route.this: v.id]
}
...
output "this_aws_dx_gateway_association_ids" {
  description = "List of Direct Connect Gateway Association identifiers"
  value       = [for k, v in aws_dx_gateway_association.this : v.id]
}
